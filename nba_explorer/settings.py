"""
Django settings for nba_explorer project.
NBA Stats Explorer — Configuration
"""
...
ROOT_URLCONF = 'nba_explorer.urls'
...
# WhiteNoise storage to serve compressed and cached files
STORAGES = {
    "default": {
        "BACKEND": "django.db.backends.postgresql" if _db_url else "django.db.backends.sqlite3",
    },
    "staticfiles": {
